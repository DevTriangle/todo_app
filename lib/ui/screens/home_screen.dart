              ...
              if (isEditing) {
                i = viewModel.categoryList.indexWhere((element) =>
                    element.categoryTitle ==
                        viewModel
                            .eventList[index].eventCategory.categoryTitle &&
                    element.categoryIconID ==
                        viewModel
                            .eventList[index].eventCategory.categoryIconID &&
                    element.categoryColor ==
                        viewModel.eventList[index].eventCategory.categoryColor);
              }

              return AppDialog(
                  title: isEditing ? viewModel.eventList[index].title : "",
                  destination: isEditing
                      ? DateTime.parse(viewModel.eventList[index].datetime)
                      : DateTime.now(),
    ...
    if (removeResponse.isSuccess) {
      final snackBar = SnackBar(
          ...
          content: AppSnackBarContent(
              label: AppLocalizations.of(context).event_delete,
              icon: Icons.delete));
                      ...
                      SliverList(
                        ...
                        FutureBuilder(
                            ...
                            builder: (fContext, snapshot) {
                              if (snapshot.data != null) {
                                if (snapshot.data!.isSuccess &&
                                    viewModel.eventList.isNotEmpty) {
                                            ...
                                            ClipRRect(
                                              ...
                                              child: Dismissible(
                                                ...
                                                onDismissed: (direction) {
                                                  _removeEvent(viewModel
                                                      .eventList[index]);
                                                },
                                                child: AppCard(
                                                    title: viewModel
                                                        .eventList[index].title,
                                                    destination: DateTime.parse(
                                                        viewModel
                                                            .eventList[index]
                                                            .datetime),
                                                    icon: AppIcons().iconsList[
                                                        viewModel
                                                            .eventList[index]
                                                            .eventCategory
                                                            .categoryIconID],
